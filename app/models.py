...
class User(UserMixin, db.Model):
    ...
    contract_number = db.Column(db.String(50), unique=True, nullable=True)
    ...
    executed_tickets = db.relationship('Ticket', foreign_keys='Ticket.executor_id', back_populates='executor')
...
class Ticket(db.Model):
    ...
    executor = db.relationship('User', foreign_keys=[executor_id], back_populates='executed_tickets')
